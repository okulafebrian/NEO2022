        ...
        <nav class=" position-fixed h-100 border-end" style="width: 20vw; z-index: 1000; background-color: white;">
            ...
            <div class="">
                <div class="pe-5 m-0 fw-semibold">
                  ...
                  <a href="/result" class="text-decoration-none m-0"><p class="text-light rounded-end ps-5 pt-3 pb-3 m-0" style="background-color: #3A3A3C;">Result</p></a>
                  <a href="" class="text-decoration-none m-0"><p class="text-dark ps-5 pt-3 pb-3 m-0">FAQ</p></a>
                  <a href="/publication-announcement" class="text-dark ps-5 pt-3 pb-3 m-0">Publication</p></a>
                </div>
            </div>
