    ...
    <div class="d-flex" style="width: 100vw;">
        <nav class=" position-fixed h-100 border-end" style="width: 20vw; z-index: 1000; background-color: white;">
            ...
            <div class="">
                <div class="pe-5 m-0 fw-semibold">
                  ...
                  <a href="/payments" class="text-decoration-none m-0"><p class="text-dark ps-5 pt-3 pb-3 m-0">Payment</p></a>
                  ...
                  <a href="/publication-announcement" class="text-decoration-none m-0" ><p class="text-light rounded-end ps-5 pt-3 pb-3 m-0" style="background-color: #3A3A3C;"> Publication</p></a>
                </div>
            </div>
        ...
        <main class="w-100 mt-4" style="margin-left: 20vw;">
            ...
            <section class="container-fluid mt-5 col-12 p-0 m-0 gx-0 d-flex gap-5 ps-5">
                <button type="button" class="btn btn-outline-warning" style="border-radius: 20px;border-color: #7B7B7B;"><strong style="color: #7B7B7B;">Certificate</strong></button>
                <button type="button" class="btn btn-outline-warning" style="border-radius: 20px;border-color: #7B7B7B;"><strong style="color: #7B7B7B;">Notifications</strong></button>
                <button type="button" class="btn btn-outline-warning" style="border-radius: 20px;border-color: #7B7B7B;"><strong style="color: #7B7B7B;">Announcement</strong></button>
            </section>
            
            <section class="container-fluid mt-5 col-9 p-0 m-0 gx-0 position-absolute" style="min-height:55vh;">
                <div class="h-100 position-absolute start-0 overflow-scroll border-top shadow pt-0  mb-5 bg-body rounded" style="width: 74vw;margin-left: 3vw;">
                    <table class="table table-striped">
                        <thead class="sticky-top" style="z-index: 100; background-color: white;">
                            <tr>
                                <th class="ps-5 pt-5 text-center">No.</th>  
                                <th class="ps-5 pt-5">Title</th>
                                <th class="ps-5 pt-5">Created_at</th>
                                <th class="ps-5 pt-5 text-center">Updated_at</th>
                                <th class="ps-5 pt-5 text-center">Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td class="ps-5 text-center">1</td>
                                <td class="ps-5">ttttt</td>
                                <td class="ps-5">27/10/2022 21:00</td>
                                <td class="ps-5 text-center">27/10/2022 23:00</td>
            ...
            <section class="position-absolute bottom-0 end-0 mb-4 me-4">
                <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#exampleModal" style="background-color: #28B4A6;"><i class="bi bi-plus text-light"></i></button>
            </section>
            ...
            <section>
                <div class="modal fade" id="exampleEdit" tabindex="-1" aria-labelledby="exampleEditLabel" aria-hidden="true">
                    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
                        <div class="modal-content p-5">
                            <div class="modal-header border-0">
                              <h5 class="modal-title" id="exampleEditLabel">Edit Announcement</h5>
                              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                              <form>
                            ...
                            <div class="modal-footer d-flex justify-content-between border-0">
                              ...
                              <button type="button" class="btn text-light " style="background-color: #28B4A6; min-width: 100px;" data-bs-toggle="modal" data-bs-target="#exampleConfirmEdit">Send</button>
                ...
                <div class="modal fade text-center" id="exampleDelete" tabindex="-1" aria-labelledby="exampleDeleteLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
                        <div class="modal-content p-5">
                            ...
                            <div class="modal-body">
                                <strong>Are you sure to delete this announcement?</strong>
                            </div>
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
                        <div class="modal-content p-3">
                            ...
                            <div class="modal-body text-center">
                                <h3>Announcement has been<br>deleted successfully!</h3>
                            </div>
                            <div class="modal-footer row border-0 d-flex justify-content-center">
                ...
                <div class="modal fade text-center" id="exampleConfirmEdit" tabindex="-1" aria-labelledby="exampleConfirmEditLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
                        <div class="modal-content p-3">
                            ...
                            <div class="modal-body text-center">
                                <h3>Announcement has been<br>successfully edited!</h3>
                            </div>
                            <div class="modal-footer row border-0 d-flex justify-content-center">
                              <button type="button" class="btn text-light col-9" style="background-color: #EE8143;" data-bs-dismiss="modal" aria-label="Close">Close</button>
                            </div>
            ...
            <section>
                <div class="modal fade text-center" id="exampleCreated" tabindex="-1" aria-labelledby="exampleCreatedLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
                        <div class="modal-content p-3">
                            <div class="modal-header border-0">
                                <i class="bi bi-patch-check-fill fs-1 w-100" style="color: #EE8143;"></i>
                            ...
                            <div class="modal-body text-center">
                                <h3>Announcement has been<br>successfully created!</h3>
                            </div>
                            <div class="modal-footer row border-0 d-flex justify-content-center">
                              <button type="button" class="btn text-light col-9" style="background-color: #EE8143;" data-bs-dismiss="modal" aria-label="Close">Close</button>
                            </div>
