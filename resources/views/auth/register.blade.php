                ...
                <div class="card" style="border-radius: 1rem;">
                    ...
                    <div class="col-md-6 col-lg-7 d-flex align-items-center">
                        <div class="card-body p-4 p-lg-5 text-black">
                            ...
                            @csrf
                                <h5 class="h1 fw-bold mb-0" style="padding-bottom: 15px">Sign up</h5>
                                <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Create new account to enter the competition</h5>
                                <div class="col">
                                ...
                                <p class="mb-5 pb-lg-2" style="color: #393f81;">Already have an account? <a href="{{ route('login') }}"
                                    style="color: #393f81;">Login Now</a></p>
