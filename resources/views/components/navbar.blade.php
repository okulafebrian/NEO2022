          ...
          <li class="nav-item rounded-circle d-flex justify-content-center p-1 position-relative" style="background-color: #DEE2E6;width: 40px;">
            <a class="nav-link active" aria-current="page" href="#">
              <div class="">
                ...
                <span class="position-absolute translate-middle rounded-circle bg-danger p-1 bottom-50 mb-1 ms-2 text-light"><span class="visually-hidden">unread messages</span></span>
              </div>
            </a>
          </li>
