            ...
            <div class="row">
                ...
                <div class="col-7">
                    @foreach ($competitions as $competition)
                        {{-- Cek apakah kompetisi ini terpilih ga --}}
                        @if ($competTicketAmount[$competition->id] > 0)
                            {{-- Tampilikan form sebanyak jumlah tiket yang dipilih --}}
                            @for ($i = 0; $i < $competTicketAmount[$competition->id]; $i++)
                                            ...
                                            @if ($competition->name == 'Debate')
                                                @for ($k = 0; $k < 2; $k++)
                                                    <div class="accordion-body row g-3">
                                                        ...
                                                        <x-form :competition=$competition :i=$i :k=$k />
                                                    </div>
                                                @endfor
                                            @else
                                                <div class="accordion-body row g-3">
                                                    <x-form :competition=$competition :i=$i :k=0 />
                                                </div>
                                            @endif
